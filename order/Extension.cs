...
namespace order
{
    internal static class Extension
    {
        ...
        public static void createpanel4(this FlowLayoutPanel panel4, List<Subtotal> subtotal_list, Label label2)
        {

            panel4.Controls.Clear();
            create_subpanel_title(panel4);
            int sum = 0;
        ...
        public static void create_subpanel_title(this FlowLayoutPanel panel4)
        {
